...
For this project from [The Odin Project](https://www.theodinproject.com/lessons/javascript-hashmap) I'll be implementing a hashMap in JavaScript.
...
> [!TIP]
> Limiting key types to strings: in the real world, hash maps can accommodate various data types as keys, including numbers, strings, or objects. However, for this project, we will only handle keys of type `string`.
